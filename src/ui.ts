...
const fr = {
  ...
  pauseSlideshow: 'Mettre le défilement en pause', playSlideshow: 'Activer le défilement automatique',
...
const en: UI = {
  ...
  pauseSlideshow: 'Pause slideshow', playSlideshow: 'Start automatic slideshow',
